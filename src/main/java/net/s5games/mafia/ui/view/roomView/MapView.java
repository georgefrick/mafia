...
public class MapView extends JPanel {
    ...
    public MapView(Area a, EditorView p) {
        ...
        up1 = getToolkit().getImage(loader.getResource("image/up6.gif"));
        up2 = getToolkit().getImage(loader.getResource("image/up12.gif"));
        down1 = getToolkit().getImage(loader.getResource("image/down6.gif"));
        down2 = getToolkit().getImage(loader.getResource("image/down12.gif"));
        mImage1 = getToolkit().getImage(loader.getResource("image/mob6.gif"));
        mImage2 = getToolkit().getImage(loader.getResource("image/mob12.gif"));
        oImage1 = getToolkit().getImage(loader.getResource("image/obj6.gif"));
        oImage2 = getToolkit().getImage(loader.getResource("image/obj12.gif"));
    }
