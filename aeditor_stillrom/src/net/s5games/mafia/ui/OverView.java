...
public class OverView extends EditorView implements ActionListener {
    ClassLoader loader;
    URL banner, gear;
    ImageIcon bannerImage, gearImage;
    private JTextField fields[];
    private JLabel labels[];
    private FlagChoice areaFlagChoice;
    protected JButton edit, revnum;
    private MudConstants t;
    private String[] areaFlagNames = {
    ...
    private int[] areaFlagData = {
            t.FLAG_DARK, t.FLAG_NO_MOB, t.FLAG_INDOORS, t.FLAG_SAFE, t.FLAG_NO_RECALL,
            t.FLAG_UNDERWATER, t.FLAG_GODS_ONLY, t.FLAG_NEWBIES_ONLY, t.FLAG_LAW,
            t.FLAG_NOWHERE, t.FLAG_NO_WEAPON, t.FLAG_NO_GATE_IN,
            t.FLAG_NO_GATE_OUT, t.FLAG_NOSUMMON, t.FLAG_SLICK, t.FLAG_NOMAGIC};
    private int flagCount = 16;

    /**
     * construct, given a (null) model.
     */
    public OverView(Area ar) {
        ...
        */
        ...
        banner = loader.getResource("logo1.gif");
        gear = loader.getResource("gear.gif");
        bannerImage = new ImageIcon(banner);
        gearImage = new ImageIcon(gear);
        JLabel gearLabel = new JLabel(gearImage);
        JLabel logoLabel = new JLabel(bannerImage);
        fields = new JTextField[12];
        labels = new JLabel[11];
        edit = new JButton("Change Values");
        revnum = new JButton("ReVnum Area");
        areaFlagChoice = new FlagChoice("Area Flags", areaFlagNames,
                areaFlagData, flagCount, this);
        ...
        */
        ...
        fields[7].setBorder(new TitledBorder("MobProgs in Area"));
        ...
        */
        ...
        insertAt(0, 0, 2, 1, logoLabel);
        insertAt(2, 0, 1, 1, gearLabel);
    ...
    public void update() {
        ...
        fields[7].setText(Integer.toString(data.getMprogCount()));
