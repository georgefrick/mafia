...
public class MudConstants {
    ...
    * different mud types
    */
    public final static int ROM = 0;
    public final static int ANIMUD = 1;
    public final static int CYNTHE = 2;
    public final static int NO_AREA = -1;
    ...
    */
    ...
    /*
    * Maximum weight of an object, should be read from a settings file!
    */
    public final static int MAX_WEIGHT = 32;

    /*
    * Cost ratio allows us to adjust costs in the mud and
    * restrict price setting a bit...
    */
    public final static int COST_RATIO = 15;
    ...
    */
    ...
    public final static int[] triggerFlags =
            {TRIG_ACT, TRIG_BRIBE, TRIG_DEATH, TRIG_ENTRY, TRIG_FIGHT, TRIG_GIVE,
                    ...
                    TRIG_EXIT, TRIG_EXALL, TRIG_DELAY, TRIG_SURR};

    public final static int NUM_TRIGGERS = 16;
}