...
import net.s5games.mafia.ui.TitledComponent;
...
public class MudShopData {
    ...
    public MudShopData(int mobVnum) {
    ...
    public MudShopData(int mobVnum, int[] bType, int pBuy, int pSell, int hOpen, int hClose) {
        this(mobVnum);
        buyType = bType;
        profitBuy = pBuy;
        profitSell = pSell;
