...
public class MudObject extends MudThing {
    ...
    public void setWeight(int newWeight) {
        if (newWeight > 0 && newWeight <= MudConstants.MAX_WEIGHT)
            weight = newWeight;
        else {
            System.out.println("Could not set illegal weight " + newWeight + ".");
            System.out.println("Weight must be > 0 and <= " + MudConstants.MAX_WEIGHT + ".");
        }
    }
