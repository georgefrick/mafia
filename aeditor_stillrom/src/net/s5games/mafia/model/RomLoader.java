...
import net.s5games.mafia.ui.JPrefs;
...
public class RomLoader extends RomIO {
                ...
                try {
                    ...
                    while (readVnum(buf2) == -1) {
                        ...
                        switch (hold1.charAt(0)) {
                            case 'D': {
                                //System.out.println("Loading deathcry");
                                hold1 = trimArgument(hold1); // remove the D.
                                String dCry = hold1.substring(0, hold1.indexOf('~'));
    ...
    public void readRooms() {
        ...
        JPrefs p = JPrefs.getPrefs();

        if (dumped && p.getPreference("Suppress Exit Error").equals("0"))
    ...
    public void readShops() {
        ...
        try {
            ...
            while (!temp.startsWith("0")) {
                ...
                shop = new MudShopData(keeper, data, bProf, sProf, openH, closeH);
